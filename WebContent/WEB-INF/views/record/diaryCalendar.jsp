		...
		<div class="content">
			...
			<div class="calendar-control text-center">
    			<ul class="clearfix">
			      ...
			      <li class="go-write">
			      	<a href="diary.do" class="btn btn-info">일기 쓰기</a>
			      </li>
			    </ul>
			  </div>
			  <!-- E: calendar-control -->
...
<!-- E: main calendar -->
	...
	{{#each schedules}}
		<li class="clearfix">
	        ...
	        <div class="list-control">
	        	<a href="#" class="add-favorite" data-scidx="{{sc_idx}}">
	            	<span class="icon">
	...
	{{#each sharedList}}
		<li class="clearfix shared-list">
	    	<a href="${pageContext.request.contextPath}/sc/detailSchedule.do?sc_idx={{sc_idx}}">
	        	<!-- S: list-content -->
	        	<div class="list-content">
	            	<h4 class="title">공유 - {{sc_title}}</h4>
	                <p>날짜 : {{sc_startDate}} ~ {{sc_endDate}}</p>
	                {{#isScAllDay sc_all_day}}
					<p>시간 : 종일</p>
					{{else}}
  ...
  <script src="${pageContext.request.contextPath}/js/ajaxAction/calendarAjax.js"></script>
  <script src="${pageContext.request.contextPath}/js/ajaxAction/loadDiaryAjax.js"></script>
</body>
</html>